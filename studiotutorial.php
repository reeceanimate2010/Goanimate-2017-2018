...
<div style="display:none">
    ...
    <script>
        ...
        studio_data.flashvars = {"apiserver":"https://wrapper-online2.herokuapp.com/","storePath":"https://josephcrosmanplays532.github.io/static/store/<store>","isEmbed":1,"ctc":"go","ut":60,"bs":"default","appCode":"go","page":"","siteId":"go","lid":13,"isLogin":"Y","retut":1,"clientThemePath":"https://josephcrosmanplays532.github.io/static/<client_theme>","themeId":"business","tlang":"en_US","presaveId":"<?php include_once("../goapi/function/videoId.php"); if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo $id + 1; } ?><?php if (isset($_GET["video"])) { echo "","goteam_draft_only":1,"isWide":1,"nextUrl":"/videos/browse.php","tray":"custom"};
        var _ccad = null;
...
function loadLegacyPreview() {
    ...
    createPreviewPlayer("playerdiv", {
        ...
        apiserver: "https://wrapper-online2.herokuapp.com/", thumbnailURL: "", copyable: "0", isPublished: "0", ctc: "go", tlang: "en_US", is_private_shared: "0",
        ...
        utm_source: "", uid: "", isTemplate: "1", showButtons: "0", chain_mids: "", showshare: "0", averageRating: "",
                ...
                ratingCount: "", fb_app_url: "/", numContact: 0, isInitFromExternal: 1, storePath: "https://josephcrosmanplays532.github.io/static/store/<store>", clientThemePath: "https://josephcrosmanplays532.github.io/static/<client_theme>", animationPath: "https://josephcrosmanplays532.github.io/static/animation/",
...
<div class="voice-vendor-ad" style="display: none;">
    ...
    </div><div class="voice-vendor-ad" style="display: none;">
        <div class="close"><a href="javascript:hideVoiceAdWidget()" onclick="javascript:return hideVoiceAdWidget()">×</a></div>
        <div id="studio-voice-vendor-container">
            <ul>
                <li><a class="gtm-ga-pageview-t2" id="voice-vendor-vb" target="_blank" href="https://voicebunny.com/?p=vyond" data-gtmv-page="/pageTracker/voicebanner/VoiceBunny" onclick="setvoicebannercookie();"><img src="https://d3v4eglovri8yt.cloudfront.net/static/019b83797158fc0c/go/img/video_voice/btn_vb.png"></a></li>
