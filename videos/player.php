...
<link rel="canonical" href="https://phpwrapper.herokuapp.com/videos/player.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>">
...
<meta name="twitter:player" content="https://phpwrapper.herokuapp.com/videos/embedvideo.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>">
...
<li class="dropdown">
	...
	<li>
		<button class="btn btn-small" data-remote="/ajax/embedMovie/?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>" data-action="video-share">Embed Your Video</button>
	</li>
                    <li>
...
jQuery('#player-overlay-dismiss').click(function() {
    jQuery('#player-overlay').hide();
            ...
            <div class="video-actions">
                ...
                <button class="btn btn-link" data-remote="/ajax/shareMovie/?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>" data-action="video-share"><span class="glyph-pro glyph-share-alt"></span> &nbsp; Share</button>
                <span class="divider">|</span>
            </div>
...
$('.video-actions').toggle($('.video-actions').find('.btn').length > 0);
            ...
            <div class="inside">
                <div class="video-social-share clearfix">
                    <div>
                        <div class="pull-left">
                            <div class="fb-like" data-href="https://phpwrapper.herokuapp.com/videos/player.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>" data-send="true" data-layout="button_count" data-width="160" data-show-faces="false"></div>
                        </div>
                    </div>
                    <div style="width:70px">
                        <div class="pull-left">
                        <div class="g-plusone" data-size="medium" data-href="https://phpwrapper.herokuapp.com/videos/player.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>"></div>
                        </div>
                    </div>
                    <div style="width:90px;">
                        <div class="pull-left">
                        <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://phpwrapper.herokuapp.com/videos/player.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>" data-hashtags="goanimate">Tweet</a>
                        </div>
                    </div>
                    <div>
                        <div class="pull-left">
                        <a data-pin-config="beside" href="//pinterest.com/pin/create/button/?url=http%3A%2F%2Fphpwrapper.herokuapp.com%2Fvideos%2Fplayer.php%3Fvideo%3D<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>&amp;media=http%3A%2F%2Fs3.amazonaws.com%2Ffs.goanimate.com%2Ffiles%2Fthumbnails%2Fmovie%2F876%2F5682876%2F13801618L.jpg&amp;description=election" data-pin-do="buttonPin"><img src="//assets.pinterest.com/images/pidgets/pin_it_button.png"/></a>
                        </div>
                    </div>
                </div>
            </div>
