...
function fbShare(ccId)
{
    ...
    var url = encodeURIComponent('https://phpwrapper.herokuapp.com/?cc_id=' + ccId);
    var title = encodeURIComponent('I just created a new character on PHPWrapper');
