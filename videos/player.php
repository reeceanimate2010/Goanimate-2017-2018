            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <a href="./embedvideo.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>">Embed Your Video</a>
                    </li>
                    <li>
                ...
                <div class="player-container col-sm-7">
                    ...
                    <div class="video-player-viewport using-flash" style="background-image: url('https://josephcrosmanplays532.github.io/GoAnimate-2016-Video-Player-Files/20077390L.jpg');">
                        <div class="video-player-wrapper embed-responsive embed-responsive-16by9">
                            <div class="embed-responsive-item" id="flash-player"><object data="https://josephcrosmanplays532.github.io/static/animation/player.swf" type="application/x-shockwave-flash" id="Player" width="100%" height="100%"><param name="bgcolor" value="#000000"><param name="scale" value="exactfit"><param name="allowScriptAccess" value="always"><param name="allowFullScreen" value="true"><param name="wmode" value="opaque"><param name="flashvars" value="movieOwner=USER%2BRETIRED&amp;movieOwnerId=0vPLkFi4Y7kw&amp;movieId=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>&amp;movieLid=0&amp;movieTitle=Butler%2BSues%2BHis%2BParents%2B%2528Series%2BFinale%2529&amp;movieDesc=Credit%2Bto%2Beveryone.%2BThis%2Bis%2Bmy%2Bfinal%2BButler%2BVideo.&amp;userId=&amp;username=&amp;uemail=&amp;ut=-1&amp;numContact=&amp;apiserver=%2F&amp;duration=140&amp;playcount=1&amp;thumbnailURL=https%3A%2F%2Fs3.amazonaws.com%2Ffs.goanimate.com%2Ffiles%2Fthumbnails%2Fmovie%2F1217%2F1588217%2F20774464L.jpg&amp;copyable=0&amp;isPublished=1&amp;ctc=go&amp;tlang=en_US&amp;is_private_shared=0&amp;autostart=0&amp;appCode=go&amp;is_slideshow=0&amp;originalId=0zEt_fo4L-5k&amp;is_emessage=0&amp;storePath=https%3A%2F%2Fjosephcrosmanplays532.github.io%2Fstore%2F3a981f5cb2739137%2F%3Cstore%3E&amp;clientThemePath=https%3A%2F%2Fjosephcrosmanplays532.github.io%2Fstatic%2F55910a7cd204c37c%2F%3Cclient_theme%3E&amp;animationPath=https%3A%2F%2Fjosephcrosmanplays532.github.io%2Fanimation%2F66453a3ba2cc5e1b%2F&amp;isEmbed=0&amp;&amp;&amp;&amp;isTemplate=0&amp;showButtons=1&amp;chain_mids=&amp;averageRating=5&amp;ratingCount=19&amp;fb_app_url=%2F&amp;ad=1&amp;endStyle=0&amp;isWide=1&amp;pwm=1&amp;s3base=https%3A%2F%2Fs3.amazonaws.com%2Ffs.goanimate.com%2F%2Chttps%3A%2F%2Fassets.vyond.com%2F&amp;initcb=flashPlayerLoaded&amp;showshare=false"><param name="movie" value="https://josephcrosmanplays532.github.io/static/animation/player.swf"></object></div>
            ...
            <div class="row settings-row">
                ...
                <div class="col-sm-5">
                    <div class="row-content">
                        <input id="copyable-url" class="form-control gtm-ga-event" type="url" readonly="true" value="https://phpwrapper.herokuapp.com/videos/embedvideo.php?video=<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>&utm_source=linkshare&amp;utm_medium=linkshare&amp;utm_campaign=usercontent" onclick="this.select()" data-gtmv-action="Share - Click text field" data-gtmv-category="" data-gtmv-label="20077390 - Guest">
                    </div>
                </div>
...
"/>
<script>
    var flashPlayerUrl = 'https://josephcrosmanplays532.github.io/static/animation/player.swf',
        flashPlayerVars = {"movieOwner":"USER+RETIRED","movieOwnerId":"0vPLkFi4Y7kw","movieId":"<?php if (isset($_GET["video"])) { echo $_GET["video"]; } else { echo "null"; } ?>","movieLid":"0","movieTitle":"Butler+Sues+His+Parents+%28Series+Finale%29","movieDesc":"Credit+to+everyone.+This+is+my+final+Butler+Video.","userId":"","username":"","uemail":"","ut":"-1","numContact":"","apiserver":"\/","duration":"140","playcount":1,"thumbnailURL":"https:\/\/s3.amazonaws.com\/fs.goanimate.com\/files\/thumbnails\/movie\/1217\/1588217\/20774464L.jpg","copyable":"0","isPublished":"1","ctc":"go","tlang":"en_US","is_private_shared":"0","autostart":"0","appCode":"go","is_slideshow":"0","originalId":"0zEt_fo4L-5k","is_emessage":"0","storePath":"https:\/\/josephcrosmanplays532.github.io\/store\/3a981f5cb2739137\/<store>","clientThemePath":"https:\/\/josephcrosmanplays532.github.io\/static\/55910a7cd204c37c\/<client_theme>","animationPath":"https:\/\/josephcrosmanplays532.github.io\/animation\/66453a3ba2cc5e1b\/","isEmbed":"0","refuser":null,"utm_source":null,"uid":null,"isTemplate":"0","showButtons":"1","chain_mids":"","averageRating":5,"ratingCount":"19","fb_app_url":"\/","ad":1,"endStyle":0,"isWide":"1","pwm":1,"s3base":"https:\/\/s3.amazonaws.com\/fs.goanimate.com\/,https:\/\/assets.vyond.com\/","initcb":"flashPlayerLoaded","showshare":false},
        h5PlayerElem = null,
        sceneDetails = {};
</script>
<script>
